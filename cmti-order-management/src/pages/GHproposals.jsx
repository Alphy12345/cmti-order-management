            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <Row gutter={[16, 16]}>
                  ...
                  <Col xs={24} md={5}>
                    <RangePicker placeholder={['Order Date Start', 'End']} value={orderDateRange} onChange={setOrderDateRange} size="large" style={{ width: '100%' }} />
                  </Col>
                  <Col xs={24} md={5}>
                    <RangePicker placeholder={['Enquiry Date Start', 'End']} value={enquiryDateRange} onChange={setEnquiryDateRange} size="large" style={{ width: '100%' }} />
                  </Col>
                </Row>
            ...
            {COORDINATOR_ADD_FIELDS.map((fieldName) => {
              ...
              return (
                <Col span={12} key={fieldName}>
                  ...
                  >
                    {isDate ? (
                      <DatePicker style={{ width: '100%' }} format="YYYY-MM-DD" placeholder={`Select ${field.label}`} />
                    ) : isTextArea ? (
